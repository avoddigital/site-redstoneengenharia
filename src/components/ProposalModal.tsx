      ...
      {open && (
        <React.Fragment>
          ...
          <motion.div 
            ...
            className="fixed inset-0 z-[100] h-screen w-screen overflow-hidden bg-black/20 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6"
            onClick={onClose}
            aria-modal="true"
            role="dialog"
          >
            ...
            <motion.div 
              ...
              className="relative w-full max-w-[600px] md:max-w-4xl bg-white rounded-[32px] shadow-2xl shadow-black/10 overflow-hidden border border-white/50 max-h-[90vh] overflow-y-auto"
            ...
            >
              ...
              <button 
                onClick={onClose}
                className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors z-50 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/20"
              >
